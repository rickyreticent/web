<%-- 
    Document   : signin
    Created on : Dec 12, 2015, 1:57:03 AM
    Author     : Kehao Xu
--%>
                ...
                <div class="bg1">
                    <div class="bg2">
                        <div class="main">
                            <!-- header -->
                            <header>
                                <h1><a href="index.html" id="logo">STAR TREK HOTEL</a></h1>
                            ...
                            <div class="box">
                                ...
                                <div class="login">
                                    <h1>Register</h1>
                                        ...
                                        <button id="signin" class="btn btn-primary btn-block btn-large">Register</button>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <script type="text/javascript">
                $(document).ready(function() {
                    $("#signin").click(function() {
                        ...
                        else if (username == "" || password == "" || username.length > 30 || password.length > 40)
