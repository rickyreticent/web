<%-- 
    Document   : changeRoom
    Created on : Dec 12, 2015, 3:51:23 AM
    Author     : Kehao Xu
--%>
    <% 
                    ...
                    <div class="box">
                        <nav>
                            <ul id="menu">
                                ...
                                <li class="active"><a href="changeRoom.jsp">Change Room</a></li>
            ...
            <script type="text/javascript">
                $(document).ready(function() {
                    ...
                    $("#cancel").click(function() {
                        ...
                        if (r) {
                            window.location.href = "changeRoom.jsp";
                        }
                    });
